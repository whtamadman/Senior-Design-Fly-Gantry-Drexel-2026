function [] = runTransformationAcquisition_new(rectCenterAll,runAcq,offset,color)
...
if runAcq
    ...
    [vid(nVideo+1), src{nVideo+1}] = initializeHammamatsuCamera('hamamatsu',1,...
        'MONO8_2048x2048_Std',100,totalTime,[],...
        [meta.calibrationFolder meta.registrationFile],true,true,stimulusFile);
