...
class PvtBufferGetSequenceDataResponse: public Serializable {
public:
    std::vector<ascii::PvtSequenceItem> sequenceData;

    PvtBufferGetSequenceDataResponse();

    PvtBufferGetSequenceDataResponse(
        std::vector<ascii::PvtSequenceItem> p_sequenceData
    );

    bool operator==(const PvtBufferGetSequenceDataResponse& other) const;
